import { users, chatbots, leads, firebaseTopics, type User, type InsertUser, type Chatbot, type InsertChatbot, type Lead, type InsertLead, type FirebaseTopic, type InsertFirebaseTopic, type ChatbotConfig, type FiveWProgress } from "@shared/schema";
import { db } from "./db";
